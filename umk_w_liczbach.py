...
if sekcja == 'Studenci':
    ...
    with d1:
    	...
    	fig.add_trace(go.Bar(x=y,y=x,orientation='h',text=y,marker_color=barwa5,hovertemplate = 'Stypendia przyznane: %{x:}'+"<extra></extra>",
...
if sekcja == 'Pracownicy':
    ...
    st.plotly_chart(px.bar(DF21[DF21['Rodzaj']==pr],x='Rok',y='Liczba',color='Jednostka',width=1400,height=500,color_discrete_sequence=['rgb(255,205,0)','rgb(250,20,20)']).update_traces(texttemplate="%{y:}",hovertemplate = 'Liczba pracowników: %{y:}',
	textposition='inside',textfont=dict( size=14))
    ...
    st.plotly_chart(px.line(DF22[DF22['Rodzaj']==pr1],x='Rok',y='Zmiana',color = 'Jednostka',width=1500,height=500,color_discrete_sequence=['rgb(0,70,180)','rgb(255,205,0)','rgb(250,20,20)'],markers=True)
