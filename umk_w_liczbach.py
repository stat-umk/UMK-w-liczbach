...
if sekcja == 'Strona główna':
    ...
    st.markdown('<div style="text-align: justify; font-size: 28px;">Uniwersytet Mikołaja Kopernika jest jednym z 43 uniwersytetów publicznych w Polsce i jedną z 10 uczelni w programie „Inicjatywa Doskonałości - Uczelnia Badawcza”. '+
    ...
    st.markdown('<div style="text-align: justify; font-size: 28px;">Uniwersytet podzielony jest na wydziały. Każdy wydział ma unikatowe logo, które charakteryzuje kolor '+
