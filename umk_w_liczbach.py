...
if sekcja == 'Studenci':
    ...
    st.plotly_chart(px.line(DF8,x='Rok',y='Odsetek',color = 'Rodzaj',width=1050,height=400,color_discrete_sequence=['rgb(0,80,170)','rgb(0,80,160)','rgb(0,50,170)','rgb(0,40,170)']).update_traces()
