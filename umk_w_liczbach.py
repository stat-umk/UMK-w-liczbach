...
if sekcja == 'Strona główna':
    ...
    with k3 :
        ...
        fig.update_layout(title="<b>Grupa dydaktyczna</b>",legend=dict(x=0,y=0),margin=dict(t=80, b=0, l=0, r=80),plot_bgcolor='white',font=dict(family='Lato',size=16,color="Black"),separators=',',title_x=0.1,showlegend=False)
        st.plotly_chart(fig,use_container_width=True)
