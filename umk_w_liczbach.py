...
if sekcja == 'Studenci':
    ...
    with c1:
        ...
        marker_line_color=kolwyd[wydzial],marker_line_width=1.5).update_xaxes(title_font=dict(size=18)).update_yaxes(title_font=dict(size=18)))
    with c2:
        ...
        marker_line_color='rgb(0,70,180)',marker_line_width=2.5).update_xaxes(title_font=dict(size=18)).update_yaxes(title_font=dict(size=18)))
    with c3:
        st.subheader('Razem')   
