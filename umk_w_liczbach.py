...
if sekcja == 'Strona główna':
    ...
    wydz2222 = q2222.selectbox('Wybierz kategorię :                                                                        ',DF28['Kategoria'].unique(),index=1)
