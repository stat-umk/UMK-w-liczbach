...
if sekcja == 'Wydziały':
    ...
    with col1:
        ...
        st.plotly_chart(px.bar(DF3[DF3['Wydział']==wydzial],x='Rok',y=kat1,width=800,height=600).update_traces(marker_color='rgb(0,80,170)',texttemplate="%{y:}",textposition='inside'))
if sekcja == 'Granty':
    st.title('Granty')
