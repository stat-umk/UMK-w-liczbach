...
if sekcja == 'Strona główna':
    ...
    wydz171 = st.multiselect('Wybierz wydział :  ',DF32['Jednostka'].unique(),['Matematyki i Informatyki'])
    st.plotly_chart(px.line(DF32[(DF32['Jednostka'].isin(wydz171))].sort_values(by=['Jednostka','Rok']),x='Rok',y='ZmianaL',hover_name="Jednostka",color='Jednostka',width=1400,height=500,symbol='Jednostka',markers=True,color_discrete_sequence=list(map(lambda x: kolwyd[x],sorted(wydz171))))
