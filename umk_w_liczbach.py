...
if sekcja == 'Studenci':
	...
	.update_xaxes(title_font=dict(size=12), title='Rok',range=[0, None],tickvals=DF8['Rok'].unique).update_yaxes(title_font=dict(size=12),title = 'Odsetek osób niepełnosprawnych',tickformat=",",range=[0, None])
