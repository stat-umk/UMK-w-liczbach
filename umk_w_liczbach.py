...
if sekcja == 'Strona główna':
    ...
    if (li == 'Kwota') and (roki in [2019,2020,2021]) :		       
	    ...
	    fig.update_xaxes(title='Kwota wnioskowana[zł]',range=[0,y[::-1][0]+y[::-1][0]/10])
	    fig.update_yaxes(title='Wydział')
	    ...
	    fig.update_xaxes(title='Liczba wniosków',range=[0,y[::-1][0]])
	    fig.update_yaxes(title='Wydział')
    ...
    if li == 'Kwota':
        ...
        fig.update_xaxes(title='Kwota przyznana[zł]',range=[0,y[::-1][0]+y[::-1][0]/10])
        fig.update_yaxes(title='Wydział')
        ...
        fig.update_xaxes(title='Liczba grantów',range=[0,y[::-1][0]])
        fig.update_yaxes(title='Wydział')
