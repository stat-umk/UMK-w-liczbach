...
if sekcja == 'Strona główna':
    ...
    st.markdown('<div style="text-align: justify; font-size: 52px;">Uniwersytet Mikołaja Kopernika jest jednym z 43 uniwersytetów publicznych w Polsce i jedną z 10 uczelni w programie „Inicjatywa Doskonałości - Uczelnia Badawcza”.</div>', unsafe_allow_html=True)
