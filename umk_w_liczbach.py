...
if sekcja == 'Strona główna':
    ...
    with k3:
        ...
        fig.update_layout(legend=dict(x=-0.3,y=1.2),margin=dict(t=80, b=0, l=0, r=160),plot_bgcolor='white',font=dict(family='Lato',size=18,color="Black"),separators=',',showlegend=False)
        st.plotly_chart(fig,use_container_width=True)
