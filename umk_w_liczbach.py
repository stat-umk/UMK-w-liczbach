...
if sekcja == 'Strona główna':
    ...
    st.plotly_chart(px.line(sorted(list(DF28[DF28['Kategoria'].isin(wydz318)]),key=lambda x: pr_cy1[x]),x='Rok',y='Wynagrodzenie',color='Kategoria',width=1400,height=500,markers=True,color_discrete_sequence=list(map(lambda x: pr_cy[x],wydz318)))
