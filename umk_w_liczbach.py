...
if sekcja == 'Nauczyciele akademiccy i administracja':
    ...
    with k1:
        ...
        fig = go.Figure(data=[go.Pie(labels=DF[(~DF["Stanowisko"].isin(['razem','lektor'])) & (DF['Rok']==2019)]['Stanowisko'],values=DF[(~DF["Stanowisko"].isin(['razem','lektor'])) & (DF['Rok']==2019)]['badawcza'])])
