...
if sekcja == 'Studenci':
    ...
    with c1:
        ...
        st.plotly_chart(px.line(DF2,x='Lata',y=kat,width=600,height=400,markers=True).update_traces(marker_color=('rgb(0,80,170)'),line_color=('rgb(0,80,170)')))
    with c3:
        ...
        st.plotly_chart(px.bar(DF3[DF3['Wydział']==wydzial],x='Rok',y=kat1,width=600,height=400,pattern_shape_sequence="\\").update_traces(marker_color=kolwyd[wydzial],texttemplate="%{y:}",textposition='inside',
