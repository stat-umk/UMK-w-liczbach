...
if sekcja == 'Studenci':
    ...
    st.plotly_chart(px.line(DF2,x='Lata',y=kat,width=1200,height=500,markers=True).update_traces(marker_color=('rgb(0,80,170)'),line_color=('rgb(0,80,170)')).update_yaxes(tickformat=","))
