...
if sekcja == 'Studenci':
    ...
    st.plotly_chart(px.line(DF15[(DF15['Wydział'].isin(sorted(wydz1)))].sort_values(by='Wydział'),x='Rok',y='Liczba',color='Wydział',width=1400,height=500,symbol='Wydział',markers=True,text='Liczba',color_discrete_sequence=list(map(lambda x: kolwyd[x],sorted(wydz1))))
