...
if sekcja == 'Studenci':
    ...
    st.plotly_chart(px.line(DF8,x='Rok',y='Odsetek',color = 'Rodzaj',width=1250,height=400,text='Odsetek',color_discrete_sequence=['rgb(0,80,170)','rgb(0,80,100)','rgb(0,20,60)','rgb(0,10,60)'])
