...
if sekcja == 'Strona główna':
    ...
    st.plotly_chart(px.line(DF28[DF28['Kategoria'].isin(wydz318)].sort_values(by=['Kategoria','Rok']),x='Rok',y='Wynagrodzenie',color='Kategoria',width=1400,height=500,markers=True,color_discrete_sequence=['rgb(170,40,150)','rgb(0,175,250)','rgb(0,70,180)','rgb(255,205,0)','rgb(255,130,30)','rgb(250,20,20)','rgb(204,204,204)'])
