...
sekcja = st.sidebar.radio(
    'Wybierz sekcję:',
    ('Strona główna','Studenci','Nauczyciele akademiccy wraz z administracja','Badania naukowe','Współpraca międzynarodowa')
 )
...
hide_st_style = """
            ...
            [data-testid="stDecoration"]{background-image: linear-gradient(90deg,#FFCD00 ,#0050AA );height: 0.5rem;}
