...
if sekcja == 'Studenci':
	...
	.update_xaxes(title_font=dict(size=12), title='Rok',range=[2011.9,2022]).update_yaxes(title_font=dict(size=12),title = 'Odsetek osób niepełnosprawnych',tickformat=",",range=[0.1, 4])
