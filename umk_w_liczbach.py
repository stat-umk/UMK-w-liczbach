...
if sekcja == 'Pracownicy':
    ...
    st.plotly_chart(px.bar(DF35[DF35['Rodzaj']==aw],x='Rok',y='Liczba',color='Jednostka',width=1400,height=500,color_discrete_sequence=['rgb(0,80,170)','rgb(255,205,0)']).update_traces(texttemplate="%{y:}",
	textposition='inside')
