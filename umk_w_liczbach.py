...
if sekcja == 'Studenci':
    ...
    fig5 = px.line(px.line(DF19,x='Rok',y='Liczba',text='Liczba',color_discrete_sequence=['rgb(0,80,170)'],markers=True)
		    .update_traces(textposition='top center',texttemplate = "%{y:.2f}%")
		    .update_layout(font_family='Lato',separators=','))
