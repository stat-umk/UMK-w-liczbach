...
if sekcja == 'Pracownicy':
    ...
    if gz1 == 'Włącz':
	    fig55 = px.line(DF30,x='Rok',y='Inflacja',color_discrete_sequence=['rgb(0,80,170)']).update_traces(textposition="top left",texttemplate = "%{y:.2f}%").update_yaxes(tickformat=",").update_layout(font_family='Lato',separators=',')
