...
if sekcja == 'Strona główna':
    ...
    with k1:
        ...
        fig.update_layout(title="<b>Grupa badawcza</b>",legend=dict(x=0,y=1.2),margin=dict(t=80, b=100, l=0, r=100),plot_bgcolor='white',font=dict(family='Lato',size=16,color="Black"),separators=',',showlegend=False,title_x=0.1)
        st.plotly_chart(fig,use_container_width=True)
    with k2:
    ...
    with k3 :
        ...
        fig.update_layout(title="<b>Grupa dydaktyczna</b>",legend=dict(x=0,y=0),margin=dict(t=80, b=100, l=0, r=160),plot_bgcolor='white',font=dict(family='Lato',size=16,color="Black"),separators=',',title_x=0.1,showlegend=False)
        st.plotly_chart(fig,use_container_width=True)
