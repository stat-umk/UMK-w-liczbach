...
if sekcja == 'Strona główna':
    ...
    if (li == 'Kwota'):
        ...
        fig.update_layout(xaxis=dict(showline=False,showgrid=True,showticklabels=True,linewidth=2,linecolor='black',gridwidth=1,gridcolor='gray',mirror=True),title='<b>Wnioski złożone',title_x=0.5,
        					height=800,width=1400,plot_bgcolor='white',margin=dict(t=200, b=0, l=180, r=50),font=dict(family='Lato',size=16,color="Black"),showlegend=True,legend_orientation='h',legend_x=-0.1,legend_yanchor='top',legend_y=1.1,
